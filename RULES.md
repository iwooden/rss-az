...
- V3 cross-president offers (to another player or a corporation with a different president) allow only the highest valid price: the lesser of the company's maximum price and the buying corporation's available cash. This price must still exceed that player's highest rejected price for the company. Same-president purchases retain their full legal price range. This restriction reduces speculative low offers that are routinely rejected.
