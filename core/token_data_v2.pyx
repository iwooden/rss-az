"""
V2 token extraction, restored from v2-final (1d1e943410f7).

Feature meanings and normalization remain those of token-data.md.
Trade-counter lifetime is controlled by GameState.v3_behavior in the engine.
